// ==UserScript==
// @name                杀佛观音·全网VIP视频破解免费看·全网最全非VIP视频去广告·极简版
// @name:zh             杀佛观音·全网VIP视频破解免费看·全网最全非VIP视频去广告·极简版
// @name:zh-CN          杀佛观音·全网VIP视频破解免费看·全网最全非VIP视频去广告·极简版
// @name:zh-TW          殺佛觀音·全網VIP視訊破解免費看·全網最全非VIP視訊去廣告·極簡版
// @namespace           杀佛观音
// @version             0.5.1
// @description         【安全无劫持、全平台设备兼容、无广告、无优惠券内容、无公众号限制】兼容电脑、手机、平板；兼容iOS、iPadOS快捷指令、Safari扩展；兼容任意支持脚本扩展的浏览器，并提供去广告教程；兼容TM篡改猴、VM暴力猴、GM油猴插件。支持1905、AcFun、爱奇艺、哔哩哔哩(B站)、风行、华数、乐视、芒果TV、咪咕视频、PP视频(PPTV)、搜狐、腾讯视频、土豆、西瓜、优酷VIP视频破解免费看、非VIP视频去广告(视频前广告、视频中途广告、视频暂停广告、水印)；支持更换、记录解析网站；支持悬浮球、快捷键操作；支持全屏隐藏悬浮球、移动悬浮球；支持源码内关闭去广告功能、切换悬浮球大小、更改解析网站列表。
// @description:zh      【安全无劫持、全平台设备兼容、无广告、无优惠券内容、无公众号限制】兼容电脑、手机、平板；兼容iOS、iPadOS快捷指令、Safari扩展；兼容任意支持脚本扩展的浏览器，并提供去广告教程；兼容TM篡改猴、VM暴力猴、GM油猴插件。支持1905、AcFun、爱奇艺、哔哩哔哩(B站)、风行、华数、乐视、芒果TV、咪咕视频、PP视频(PPTV)、搜狐、腾讯视频、土豆、西瓜、优酷VIP视频破解免费看、非VIP视频去广告(视频前广告、视频中途广告、视频暂停广告、水印)；支持更换、记录解析网站；支持悬浮球、快捷键操作；支持全屏隐藏悬浮球、移动悬浮球；支持源码内关闭去广告功能、切换悬浮球大小、更改解析网站列表。
// @description:zh-CN   【安全无劫持、全平台设备兼容、无广告、无优惠券内容、无公众号限制】兼容电脑、手机、平板；兼容iOS、iPadOS快捷指令、Safari扩展；兼容任意支持脚本扩展的浏览器，并提供去广告教程；兼容TM篡改猴、VM暴力猴、GM油猴插件。支持1905、AcFun、爱奇艺、哔哩哔哩(B站)、风行、华数、乐视、芒果TV、咪咕视频、PP视频(PPTV)、搜狐、腾讯视频、土豆、西瓜、优酷VIP视频破解免费看、非VIP视频去广告(视频前广告、视频中途广告、视频暂停广告、水印)；支持更换、记录解析网站；支持悬浮球、快捷键操作；支持全屏隐藏悬浮球、移动悬浮球；支持源码内关闭去广告功能、切换悬浮球大小、更改解析网站列表。
// @description:zh-TW   【安全無劫持、全平臺設備兼容、無廣告、無優惠券內容、無公眾號限製】兼容電腦、手機、平板；兼容iOS、iPadOS快捷指令、Safari擴展；兼容任意支持腳本擴展的瀏覽器，並提供去廣告教程；兼容TM篡改猴、VM暴力猴、GM油猴插件。支持1905、AcFun、愛奇藝、嗶哩嗶哩(B站)、風行、華數、樂視、芒果TV、咪咕視頻、PP視頻(PPTV)、搜狐、騰訊視頻、土豆、西瓜、優酷VIP視頻破解免費看、非VIP視頻去廣告(視頻前廣告、視頻中途廣告、視頻暫停廣告、水印)；支持更換、記錄解析網站；支持懸浮球、快捷鍵操作；支持全屏隱藏懸浮球、移動懸浮球；支持程式碼內關閉去廣告功能、切換懸浮球大小、更換解析網站列表。
// @author              杀佛观音
...
(function () {
    ...
    //↓修改此参数更改解析网站列表，排名按照首字母排序
    var KillBuddha_jiexi = [
        {name:'(s)52damu',src:'https://jx.52damu.com/?url=',},
        {name:'618g',src:'https://jx.618g.com/?url=',},
        {name:'660e',src:'https://660e.com/?url=',},
        {name:'(s)admin',src:'https://www.administratorw.com/admin.php?url=',},
        {name:'attakids',src:'https://jsap.attakids.com/?url=',},
        {name:'baiyu',src:'https://jx.baiyu.buzz/?url=',},
        {name:'blbo',src:'https://jx.blbo.cc:4433/?url=',},
        {name:'(s)bljiex',src:'https://vip.bljiex.cc/?v=',},
        {name:'ergan',src:'https://jx.ergan.top/?url=',},
        {name:'(b)favnow',src:'https://dp.favnow.com/?url=',},
        {name:'h8jx',src:'https://www.h8jx.com/jiexi.php?url=',},
        {name:'(s)m1907',src:'https://z1.m1907.cn/?jx=',},
        {name:'(b)m2090',src:'https://m2090.com/?url=',},
        {name:'m3u8',src:'https://jx.m3u8.tv/jiexi/?url=',},
        {name:'(b)nxflv',src:'https://www.nxflv.com/?url=',},
        {name:'(b)okjx',src:'https://okjx.cc/?url=',},
        {name:'parwix',src:'https://jx.parwix.com:4433/player/analysis.php?v=',},
        {name:'vercel',src:'https://thinkibm.vercel.app/?url=',},
        {name:'xmflv',src:'https://jx.xmflv.com/?url=',},
        {name:'(b)yemu',src:'https://www.yemu.xyz/?url=',},
        {name:'(s)yaosou',src:'https://www.yaosou.cc/jiexi/?v=',},
    ];
    ...
    var KillBuddha_src,KillBuddha_div;
    match = window.location.href.match(/(^https?:\/\/player\.aplus\.pptv\.com\/)?/i);
    if(!match || match[0] === ''){
        var x = 0, y = 0, left = 0, top = 0, down = !1, move = !1, i = 0, clear = null, time = 666;
        KillBuddha_div = document.createElement('div');
        ...
        KillBuddha_coexist(document, 'touchstart', function (e) {
            if (e.target !== KillBuddha_div) return;
            KillBuddha_div.style['box-shadow'] = '0px 0px 8px 3px';
        ...
        KillBuddha_coexist(window, 'onresize', function () {
            KillBuddha_div.style.left = '';
            KillBuddha_div.style.top = '';
        });
        ...
        KillBuddha_src = localStorage.getItem('KillBuddha_src');
        if (!KillBuddha_src) {
            KillBuddha_src = KillBuddha_jiexi[0].src;
            localStorage.setItem('KillBuddha_src', KillBuddha_src);
        }
        var KillBuddha_select = document.createElement('select');
        KillBuddha_select.style = 'width:100%;height:30px;font-size:20px;opacity:0.6;background:black;color:white;border-radius:15px 15px 0 0;';
        KillBuddha_jiexi.forEach(function (list_){
            var KillBuddha_option = document.createElement('option');
            KillBuddha_option.value = list_.src;
            KillBuddha_option.text = list_.name;
            if (list_.src === KillBuddha_src) {
                KillBuddha_option.selected = 'selected';
            }
            KillBuddha_select.appendChild(KillBuddha_option);
        });
        KillBuddha_select.onchange = function (e) {
            KillBuddha_src = this.value;
            localStorage.setItem('KillBuddha_src', KillBuddha_src);
        };
        KillBuddha_select.onclick = KillBuddha_select.onmousedown = function (e) {
            if (e.stopPropagation) e.stopPropagation();
        };
        KillBuddha_div.appendChild(KillBuddha_select);
        setInterval(function (){
            if(document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement) {
                ...
                document.querySelectorAll('video').forEach(function (player) {
                    if (Math.abs(parseInt(player.offsetHeight) - parseInt(window.innerHeight)) < 10 && Math.abs(parseInt(player.offsetWidth) - parseInt(window.innerWidth)) < 10) isWebFull = !0;
                });
                if (window.location.href.match(/^https?:\/\/v\.pptv\.com\//i) && document.querySelector('.w-expandOut')) isWebFull = !0;
                if (isWebFull) {
                    KillBuddha_div.style.display = 'none';
                } else {
    ...
    var KillBuddha_ad = void 0;
    function show(){
        if(!KillBuddha_no_ads || KillBuddha_ad) return;
        KillBuddha_ad = document.createElement('div');
        KillBuddha_ad.style = 'z-index:99999999999999;position:fixed;width:250px;height:120px;left:25%;top:30%;font-size:22px;background-color:#FCCF33;box-shadow:rgba(15, 66, 76, 0.25) 0px 0px 8px 3px;border-radius:15px;overflow:hidden;background-size:100% 100%;';
        (document.querySelector('body')?document.body:document.documentElement).appendChild(KillBuddha_ad);
        ...
        KillBuddha_div_son.onclick = function(e){
            KillBuddha_no_ads = !1;
            KillBuddha_ad.remove();
        };
        KillBuddha_ad.appendChild(KillBuddha_div_son);
